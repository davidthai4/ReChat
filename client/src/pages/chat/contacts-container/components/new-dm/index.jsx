        ...
        <>
            ...
            <Dialog open={openNewContactModel} onOpenChange={setOpenNewContactModel}>
                <DialogContent className="bg-[#181920] border-none text-white w-[400px] h-[400px] flex flex-col">
                    <DialogHeader>
                        <DialogTitle>Please select a contact to start a new DM.</DialogTitle>
                    ...
                    <ScrollArea className="h-[250px]">
                        <div className="flex flex-col gap-2">
                            {searchedContacts.map((contact) => (
                                <div key={contact._id} className="flex gap-3 items-center cursor-pointer hover:bg-[#2c2e3b] p-2 rounded" onClick={() => handleContactClick(contact)}>
                    ...
                    {searchedContacts.length <= 0 && !hasSearched && (
                        <div className="flex-1 md:bg-[#1c1d25] md:flex mt-5 flex-col justify-center items-center duration-1000 transition-all">
                            ...
                            <div className="text-opacity-80 text-white flex flex-col gap-5 items-center mt-5 lg:text-2xl text-xl transition-all duration-300 text-center">
                                <h3 className="roboto-mono">
                                    Hi<span className="text-purple-500">!</span> Search for a
