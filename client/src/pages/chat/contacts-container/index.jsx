...
const ContactsContainer = () => {
    ...
    useEffect(() => {
        const getContacts = async () => {
            const response = await apiClient.get(GET_CONTACTS_FOR_DM_LIST_ROUTE, { withCredentials: true });
...
const Logo = () => {
    return (
        <div className="flex p-s justify-start items-center gap-2">
            <svg
                id="logo-38"
                width="78"
                height="32"
            ...
            <span className="text-3xl font-semibold ">ReChat</span>
        </div>
    );
};
